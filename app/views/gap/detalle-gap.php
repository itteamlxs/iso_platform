                ...
                <div class="bg-white rounded-xl shadow-sm border-l-4 <?php echo $prioridad_color[$gap['prioridad']]; ?> p-6">
                    ...
                    <div class="mt-6">
                        <div class="flex items-center justify-between mb-2">
                            ...
                            <span class="text-lg font-bold text-blue-600"><?php echo $gap['avance']; ?>%</span>
                        </div>
                        <div class="w-full bg-gray-200 rounded-full h-4">
                            <div class="bg-blue-600 h-4 rounded-full transition-all" style="width: <?php echo $gap['avance']; ?>%"></div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="border border-gray-200 rounded-lg p-4">
                                <div class="flex items-start justify-between">
                                    ...
                                    <span class="text-xs px-3 py-1 rounded-full font-semibold ml-4 <?php echo $estado_color[$accion['estado']]; ?>">
